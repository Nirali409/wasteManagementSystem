...
namespace wasteManagementSystem.Controllers
{
    public class ServiceTypesController : Controller
    {
        ...
        public ServiceTypesController(wasteManagementContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ServiceTypeId,ServiceTypeName")] ServiceType serviceType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ServiceTypeId,ServiceTypeName")] ServiceType serviceType)
        {
